...
$(function() {
	...
	window.test_mode = (window.location.hash && window.location.hash.match(/^(?:#.+)*#test(?:#.+)*$/i)); // dumb to append things to window
...
////////////////////////////////////////////////////////////////
	...
	if(!gKnowsYouCanUseKeyboard) {
		window.gKnowsYouCanUseKeyboardTimeout = setTimeout(function() {
			window.gKnowsYouCanUseKeyboardNotification = new MPPNotification({title: "Did you know!?!",
...
////////////////////////////////////////////////////////////////
	...
	$("#play-alone-btn").on("click", function(evt) {
		...
		setTimeout(function() {
			new MPPNotification({id: "share", title: "Playing alone", html: 'You are playing alone in a room by yourself, but you can always invite \
	...
	(function() {
		function submit() {
			...
			setTimeout(function() {
			new MPPNotification({id: "share", title: "Created a Room", html: 'You can invite friends to your room by sending them the link.<br/><br/>\
				<a href="#" onclick="window.open(\'https://www.facebook.com/sharer/sharer.php?u=\'+encodeURIComponent(location.href),\'facebook-share-dialog\',\'width=626,height=436\');return false;">Share on Facebook</a><br/><br/>\
				<a href="http://twitter.com/home?status='+encodeURIComponent(location.href)+'" target="_blank">Tweet</a>', duration: 25000});
		}, 1000);
		};
